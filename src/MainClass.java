...
public class MainClass {
   ...
   public static final int CARS_COUNT = 4;
    ...
    static Semaphore tunnel = new Semaphore (CARS_COUNT/2); // это для тунела 2 участника допуск
    ...
    public static void main(String[] args) {
        ...
        while (finishLine.getCount() > 0) //Проверяем, финальную дистанцию что все проехали
            try {
                Thread.sleep(100);
            } catch (InterruptedException e) {
                e.printStackTrace();
